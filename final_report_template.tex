...
\begin{center}\includegraphics[width=0.7\linewidth]{final_report_template_files/figure-latex/unnamed-chunk-6-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{final_report_template_files/figure-latex/unnamed-chunk-12-1} \end{center}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Example structure:}
\CommentTok{\# set.seed(123)}
\CommentTok{\# train\_index \textless{}{-} sample(seq\_len(nrow(data\_clean)), size = 0.8 * nrow(data\_clean))}
\CommentTok{\# train \textless{}{-} data\_clean[train\_index, ]}
\CommentTok{\# test  \textless{}{-} data\_clean[{-}train\_index, ]}
\CommentTok{\#}
\CommentTok{\# model \textless{}{-} glm(target \textasciitilde{} ., data = train, family = binomial)}
\CommentTok{\# preds \textless{}{-} predict(model, newdata = test, type = "response")}
